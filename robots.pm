...
'Dalvik/',
'CFNetwork',
'(firefox/)([0-9]\.|[0-1][0]\.)', # old robots using firefox < version 11 not identifying themselves as a robot.
'IDG/UK',
'facebookexternalhit/',
'msie8',
'360Spider',
...
# Generic robot
'robot','robot ( catchall )',
'oBot/','oBot',
'blog','blog ( catchall )',
'checker','checker ( catchall )',
'crawl','crawl ( catchall )',
'discover','discover ( catchall )',
'feed','feed ( catchall )',
'fetcher','fetcher ( catchall )',
'hunter','hunter ( catchall )',
'link','link ( catchall )',
'scanner','scanner ( catchall )',
'seek','seek ( catchall )',
'sitemap','sitemap ( catchall )',
'spider','spider ( catchall )',
'sucker','sucker ( catchall )',
'survey','survey ( catchall )',
'validator','validator ( catchall )',
'bot[\s_+:,\.\;\/\\\-]','Unknown robot identified by bot\* ( catchall )',
'[\s_+:,\.\;\/\\\-]bot','Unknown robot identified by \*bot ( catchall )',
'curl','Curl ( catchall )',
'php','A PHP script ( catchall )',
'ruby/','Ruby script ( catchall )',
'no_user_agent','empty user agent string ( catchall )',
# Unknown robots identified by hit on robots.txt
'unknown','Unknown robot (identified by hit on robots.txt) ( catchall )'
);
