...
<PADGEN_PML>
	...
	<Program_Info>
		...
		<Program_Version>6.5</Program_Version>
		...
		<Program_OS_Support>Windows2000,WinXP,Windows2003,Unix,Linux,MS-DOS,OS/2,OS/2 Warp,OS/2 Warp 4,Mac PPC,Mac OS X,Mac Other,OpenVMS</Program_OS_Support>
		<Program_Language>English,Arabic,ChineseSimplified,ChineseTraditional,Czech,Danish,Finnish,French,German,Greek,Hungarian,Italian,Japanese,Korean,Other,Polish,Portuguese,Russian,Spanish,Swedish</Program_Language>
		<Program_Change_Info />
		...
		<File_Info>
			<Filename_Versioned>awstats-6.5.zip</Filename_Versioned>
			<Filename_Previous>awstats-6.4.zip</Filename_Previous>
			<Filename_Generic>awstats.zip</Filename_Generic>
			<Filename_Long>awstats.zip</Filename_Long>
			<File_Size_Bytes>1159219</File_Size_Bytes>
			<File_Size_K>1132</File_Size_K>
	...
	<Program_Descriptions>
		<English>
			...
			<Char_Desc_450>AWStats is a free powerful and featureful web server logfile analyzer (Perl script) that shows you all your Web statistics including visits, unique visitors, pages, hits, rush hours, os, browser's versions, search engines, keywords, robots visits, broken links and more...
Works with all major web, wap, proxy servers and some mail and ftp servers. Works as a CGI and/or from command line.
...
Fonctionne avec les log de tout serveur Web.</Char_Desc_450>
...
Ce programme supporte de plus les serveurs virtuels, des plugins et de nombreuses fonctionalités.</Char_Desc_2000>
	...
	<Web_Info>
		<Application_URLs>
			...
			<Application_Icon_URL>http://awstats.sourceforge.net/docs/images/awstats_logo1.png</Application_Icon_URL>
		...
		<Download_URLs>
			...
			<Secondary_Download_URL>http://prdownloads.sourceforge.net/awstats/awstats-65.zip</Secondary_Download_URL>
