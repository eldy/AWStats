...
print &hblink("Help", "help.cgi?param=AllowFullYearView")." </td> </tr>\n";
...
if ($in{'advanced'} == 1) {
	...
	print &hblink("Help", "help.cgi?param=EnableLockForUpdate")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=DNSStaticCacheFile")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=AllowAccessFromWebToAuthenticatedUsersOnly")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=AllowAccessFromWebToFollowingAuthenticatedUsers")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=AllowAccessFromWebToFollowingIPAddresses")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=CreateDirDataIfNotExists")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=SaveDatabaseFilesWithPermissionsForEveryone")." </td> </tr>\n";
	print "<tr> <td><b>PurgeLogFile</b></td> <td> <input size=10 name=PurgeLogFile type=text value='$lconf->{'PurgeLogFile'}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=PurgeLogFile")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=ArchiveLogRecords")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=AuthenticatedUsersNotCaseSensitive")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=URLNotCaseSensitive")." </td> </tr>\n";
	print "<tr> <td><b>URLWithAnchor</b></td> <td> <input size=10 name=URLWithAnchor type=text value='$lconf->{'URLWithAnchor'}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=URLWithAnchor")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=URLQuerySeparators")." </td> </tr>\n";
	print "<tr> <td><b>URLWithQuery</b></td> <td> <input size=10 name=URLWithQuery type=text value='$lconf->{'URLWithQuery'}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=URLWithQuery")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=URLWithQueryWithoutFollowingParameters")." </td> </tr>\n";
...
if ($in{'advanced'} == 3) {
	...
	print &hblink("Help", "help.cgi?param=UseFramesWhenCGI")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=DetailedReportsOnNewWindows")." </td> </tr>\n";
	print "<tr> <td><b>Expires</b></td> <td> <input size=10 name=Expires type=text value='$lconf->{'Expires'}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=Expires")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=MaxRowsInHTMLOutput")." </td> </tr>\n";
	print "<tr> <td><b>Lang</b></td> <td> <input size=10 name=Lang type=text value='$lconf->{'Lang'}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=Lang")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=ShowDaysOfMonthStats")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=ShowEMailReceivers")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=ShowFileTypesStats")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=ShowFileSizesStats")." </td> </tr>\n";
	print "<tr> <td><b>ShowOSStats</b></td> <td> <input size=10 name=ShowOSStats type=text value='$lconf->{'ShowOSStats'}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=ShowOSStats")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=ShowBrowsersStats")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=ShowKeyphrasesStats")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=ShowHTTPErrorsStats")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=AddDataArrayMonthStats")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=AddDataArraySHowDaysOfMonthStats")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=AddDataArrayShowDaysOfWeekStats")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=MaxNbOfHostsShown ")." </td> </tr>\n";
	print "<tr> <td><b>MinHitHost    </b></td> <td> <input size=10 name=MinHitHost     type=text value='$lconf->{'MinHitHost    '}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=MinHitHost    ")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=MaxNbOfLoginShown ")." </td> </tr>\n";
	print "<tr> <td><b>MinHitLogin   </b></td> <td> <input size=10 name=MinHitLogin    type=text value='$lconf->{'MinHitLogin   '}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=MinHitLogin   ")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=MaxNbOfBrowsersShown ")." </td> </tr>\n";
	print "<tr> <td><b>MinHitBrowser </b></td> <td> <input size=10 name=MinHitBrowser  type=text value='$lconf->{'MinHitBrowser '}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=MinHitBrowser ")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=MaxNbOfRefererShown ")." </td> </tr>\n";
	print "<tr> <td><b>MinHitRefer   </b></td> <td> <input size=10 name=MinHitRefer    type=text value='$lconf->{'MinHitRefer   '}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=MinHitRefer   ")." </td> </tr>\n";
	...
	print &hblink("Help", "help.cgi?param=MaxNbOfKeywordsShown ")." </td> </tr>\n";
	print "<tr> <td><b>MinHitKeyword </b></td> <td> <input size=10 name=MinHitKeyword  type=text value='$lconf->{'MinHitKeyword '}'> </td> <td> ";
	print &hblink("Help", "help.cgi?param=MinHitKeyword ")." </td> </tr>\n";
...
#	print &hblink("Help", "help.cgi?param=color_TableRowTitle")." </td> </tr>\n";
...
#	print &hblink("Help", "help.cgi?param=color_TableBGRowTitle")." </td> </tr>\n";
...
#	print &hblink("Help", "help.cgi?param=color_TableBorder")." </td> </tr>\n";
#	print "<tr> <td><b>color_text</b></td> <td> <input size=10 name=color_text type=text value='$lconf->{'color_text'}'> </td> <td> ";
#	print &hblink("Help", "help.cgi?param=color_text")." </td> </tr>\n";
